...
export default function ProfilePage() {
  ...
  const inputCls = 'w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-800 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-colors placeholder-gray-400 dark:placeholder-gray-500'
  const selectCls = 'w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-800 dark:text-white focus:ring-2 focus:ring-orange-500 outline-none transition-colors'
  const textareaCls = 'w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-800 dark:text-white focus:ring-2 focus:ring-orange-500 outline-none resize-none transition-colors placeholder-gray-400 dark:placeholder-gray-500'
            ...
            {activeTab === 'info' && (
              <form onSubmit={onSaveProfile} className="space-y-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2 px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800 text-sm text-gray-400 dark:text-gray-500">
                    {user?.email}
                    <span className="ml-auto text-xs bg-gray-100 dark:bg-gray-700 dark:text-gray-400 px-2 py-0.5 rounded-full">
                      No editable
                    </span>
                  </div>
                </div>
              ...
              <form onSubmit={onSavePassword} className="space-y-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  {passErrors.current_password && (
                    <p className="text-xs text-red-500">{passErrors.current_password.message}</p>
                  )}
                </div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  {passErrors.new_password && (
                    <p className="text-xs text-red-500">{passErrors.new_password.message}</p>
                  )}
                </div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  {passErrors.confirm_password && (
                    <p className="text-xs text-red-500">{passErrors.confirm_password.message}</p>
                  )}
                </div>
